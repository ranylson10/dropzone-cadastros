...
test.describe('Rodada 88E — pagamento público de vaga', () => {
  test('site expõe meios seguros e preserva retorno para compra de vaga', async () => {
    ...
    expect(purchase).toContain("billingType: useFlexibleCheckout ? 'UNDEFINED' : method === 'cartao' ? 'CREDIT_CARD' : 'PIX'")
    ...
    expect(sellerPanel).toContain("saleMethod === 'paypal' ? 'Gerar PayPal'")
