        ...
        <div className="game-form-panel">
          ...
          <div className="game-rules-panel">
            ...
            <div className="mini-grid three">
              ...
              <Field label="Resultado decisivo"><select value={props.value.define_campeao ? 'campeao' : 'classificacao'} onChange={(e) => patch({ define_campeao: e.target.value === 'campeao' })}><option value="classificacao">Pontua para classifica̤̣o da fase</option><option value="campeao">Define o campẹo</option></select></Field>
            </div>
          </div>
