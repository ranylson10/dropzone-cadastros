...
export function ProdutoraPanel(props: {
  ...
  function championshipToForm(champ: DropZoneRow): CampeonatoFormValue {
    return {
      ...
      pagamento_pix_ativo: champ.data?.pagamento_pix_ativo !== false,
      pagamento_cartao_ativo: champ.data?.pagamento_cartao_ativo !== false,
      pagamento_paypal_ativo: champ.data?.pagamento_paypal_ativo === true,
