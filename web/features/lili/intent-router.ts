...
const NORMALIZED_RULES: Array<{ intent: LiliIntent; phrases: string[] }> = [
  ...
  },
  {
    ...
    phrases: ['central competitiva', 'pontuacao e resultados', 'operacao competitiva', 'jogos e resultados', 'central competitiva do campeonato', 'central competitiva del torneo', 'competitive operations center'],
  },
  {
