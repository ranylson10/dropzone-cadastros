...
type Summary = {
  ...
  alerts: Array<{ id: string; severity: 'critical' | 'warning' | 'info'; category: 'capacity' | 'structure' | 'schedule' | 'lineup' | 'registration' | 'payment' | 'result' | 'rulebook'; scope: 'championship' | 'team' | 'game'; title: string; message: string; context: string; impact: string; recommendation: string; action: string; href: string; due_at?: string | null; priority_score?: number; status?: 'new' | 'read' | 'resolved' | 'dismissed'; status_note?: string | null; status_updated_at?: string | null }>
