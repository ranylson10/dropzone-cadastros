        ...
        {selectedChamp ? (
          <>
            ...
            <nav className="champ-subtabs-ref" aria-label="Abas do campeonato">
              <button className={tab === 'equipes' ? 'active' : ''} onClick={() => setTab('equipes')}>Equipes</button>
              <button className={tab === 'jogadores' ? 'active' : ''} onClick={() => setTab('jogadores')}>Jogadores</button>
              <button className={tab === 'grupos' ? 'active' : ''} onClick={() => setTab('grupos')}>Fases e grupos</button>
              <button className={tab === 'jogos' ? 'active' : ''} onClick={() => setTab('jogos')}>Jogos</button>
