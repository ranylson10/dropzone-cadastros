...
const styles=StyleSheet.create({
  ...
  contextActions:{flexDirection:'row',gap:6,marginTop:4},monthBar:{marginHorizontal:spacing.md,marginTop:7,minHeight:52,flexDirection:'row',alignItems:'center',backgroundColor:'#e8e2d8',borderRadius:10,overflow:'hidden'},
  ...
  addText:{color:colors.surface,fontSize:8,fontWeight:'900',textTransform:'uppercase'},editor:{margin:spacing.md,gap:7,padding:9,backgroundColor:colors.surface,borderWidth:1,borderColor:colors.line,borderRadius:10},
  editorTitle:{color:colors.ink,fontSize:10,fontWeight:'900'},input:{minHeight:40,paddingHorizontal:9,color:colors.ink,backgroundColor:'#f2eee7',borderWidth:1,borderColor:colors.line,borderRadius:7,fontWeight:'800'},
  textarea:{minHeight:62,textAlignVertical:'top',paddingTop:9},inline:{flexDirection:'row',gap:5},flex:{flex:1},smallInput:{width:66,minHeight:40,paddingHorizontal:7,color:colors.ink,backgroundColor:'#f2eee7',borderWidth:1,borderColor:colors.line,borderRadius:7,fontWeight:'800'},
  fieldLabel:{marginTop:2,color:colors.muted,fontSize:7,fontWeight:'900'},chips:{flexDirection:'row',flexWrap:'wrap',gap:4},choice:{paddingHorizontal:8,paddingVertical:7,backgroundColor:'#eee9e1',borderRadius:6},choiceActive:{backgroundColor:colors.brandDark},
  ...
  primary:{flex:1,minHeight:40,alignItems:'center',justifyContent:'center',backgroundColor:colors.brand,borderRadius:7},primaryText:{color:colors.surface,fontSize:8,fontWeight:'900',textTransform:'uppercase'},
  secondary:{minHeight:38,paddingHorizontal:10,alignItems:'center',justifyContent:'center',backgroundColor:'#eee9e1',borderRadius:7},secondaryText:{color:colors.ink,fontSize:7,fontWeight:'900',textTransform:'uppercase'},
  danger:{minHeight:38,paddingHorizontal:10,alignItems:'center',justifyContent:'center',backgroundColor:'#fff1f1',borderRadius:7},dangerText:{color:'#b42318',fontSize:7,fontWeight:'900',textTransform:'uppercase'},
  ...
  empty:{margin:spacing.md,minHeight:60,flexDirection:'row',alignItems:'center',justifyContent:'center',gap:8,backgroundColor:'#e7e1d8',borderRadius:10},emptyText:{color:colors.muted,fontSize:11,fontWeight:'800'},
  ...
  row:{minHeight:62,flexDirection:'row',alignItems:'center',gap:8,paddingRight:8,paddingVertical:6,backgroundColor:'#e8e2d8'},colorRail:{alignSelf:'stretch',width:4},
