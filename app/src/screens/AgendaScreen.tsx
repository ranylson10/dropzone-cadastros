  ...
  return (
    <ScrollView style={styles.page} contentContainerStyle={styles.content}>
      ...
      {canUseScope?<>
        ...
        {auth.session?<TouchableOpacity style={styles.addButton} onPress={openNew}><Ionicons name="add" size={18} color={colors.onBrand}/><Text style={styles.addText}>Adicionar compromisso</Text></TouchableOpacity>:null}
...
const styles=StyleSheet.create({
  ...
  scopeButton:{flex:1,minHeight:38,alignItems:'center',justifyContent:'center',backgroundColor:colors.surface},scopeActive:{backgroundColor:colors.brand},disabled:{opacity:.35},
  scopeText:{color:colors.muted,fontSize:8,fontWeight:'900',textTransform:'uppercase'},scopeTextActive:{color:colors.onBrand},
  contextMissing:{margin:spacing.md,padding:12,alignItems:'center',gap:6,backgroundColor:colors.surface,borderWidth:1,borderColor:colors.line,borderRadius:10},
  ...
  contextActions:{flexDirection:'row',gap:6,marginTop:4},monthBar:{marginHorizontal:spacing.md,marginTop:7,minHeight:52,flexDirection:'row',alignItems:'center',backgroundColor:colors.surface,borderWidth:1,borderColor:colors.line,borderRadius:10,overflow:'hidden'},
  ...
  monthTitle:{marginTop:2,color:colors.ink,fontSize:14,fontWeight:'900',textTransform:'uppercase'},addButton:{marginHorizontal:spacing.md,marginTop:6,minHeight:40,flexDirection:'row',gap:6,alignItems:'center',justifyContent:'center',backgroundColor:colors.brand,borderRadius:8},
  addText:{color:colors.onBrand,fontSize:8,fontWeight:'900',textTransform:'uppercase'},editor:{margin:spacing.md,gap:7,padding:9,backgroundColor:colors.surface,borderWidth:1,borderColor:colors.line,borderRadius:10},
  editorTitle:{color:colors.ink,fontSize:10,fontWeight:'900'},input:{minHeight:40,paddingHorizontal:9,color:colors.ink,backgroundColor:colors.surfaceRaised,borderWidth:1,borderColor:colors.line,borderRadius:7,fontWeight:'800'},
  textarea:{minHeight:62,textAlignVertical:'top',paddingTop:9},inline:{flexDirection:'row',gap:5},flex:{flex:1},smallInput:{width:66,minHeight:40,paddingHorizontal:7,color:colors.ink,backgroundColor:colors.surfaceRaised,borderWidth:1,borderColor:colors.line,borderRadius:7,fontWeight:'800'},
  fieldLabel:{marginTop:2,color:colors.muted,fontSize:7,fontWeight:'900'},chips:{flexDirection:'row',flexWrap:'wrap',gap:4},choice:{paddingHorizontal:8,paddingVertical:7,backgroundColor:colors.surfaceRaised,borderRadius:6},choiceActive:{backgroundColor:colors.brand},
  choiceText:{color:colors.ink,fontSize:6.5,fontWeight:'900',textTransform:'uppercase'},choiceTextActive:{color:colors.onBrand},editorActions:{flexDirection:'row',gap:5},
  primary:{flex:1,minHeight:40,alignItems:'center',justifyContent:'center',backgroundColor:colors.brand,borderRadius:7},primaryText:{color:colors.onBrand,fontSize:8,fontWeight:'900',textTransform:'uppercase'},
  secondary:{minHeight:38,paddingHorizontal:10,alignItems:'center',justifyContent:'center',backgroundColor:colors.surfaceRaised,borderRadius:7},secondaryText:{color:colors.ink,fontSize:7,fontWeight:'900',textTransform:'uppercase'},
  danger:{minHeight:38,paddingHorizontal:10,alignItems:'center',justifyContent:'center',backgroundColor:'rgba(224, 122, 122, .12)',borderRadius:7},dangerText:{color:colors.danger,fontSize:7,fontWeight:'900',textTransform:'uppercase'},
  ...
  warning:{marginHorizontal:spacing.md,marginTop:7,padding:10,backgroundColor:'rgba(212, 165, 87, .12)',color:colors.warning,fontSize:10,fontWeight:'800'},
  success:{marginHorizontal:spacing.md,marginTop:7,padding:10,backgroundColor:'rgba(101, 185, 130, .12)',color:colors.success,fontSize:10,fontWeight:'800'},
  empty:{margin:spacing.md,minHeight:60,flexDirection:'row',alignItems:'center',justifyContent:'center',gap:8,backgroundColor:colors.surface,borderWidth:1,borderColor:colors.line,borderRadius:10},emptyText:{color:colors.muted,fontSize:11,fontWeight:'800'},
  groups:{margin:spacing.md,gap:7},dayGroup:{gap:1,backgroundColor:colors.line,borderRadius:10,overflow:'hidden'},dayHeader:{minHeight:30,flexDirection:'row',alignItems:'center',justifyContent:'space-between',paddingHorizontal:9,backgroundColor:colors.brandDark},
  day:{color:colors.ink,fontSize:8,fontWeight:'900'},dayCount:{color:colors.brandLight,fontSize:8,fontWeight:'900'},
  row:{minHeight:62,flexDirection:'row',alignItems:'center',gap:8,paddingRight:8,paddingVertical:6,backgroundColor:colors.surface},colorRail:{alignSelf:'stretch',width:4},
  dateBox:{width:42,height:42,alignItems:'center',justifyContent:'center',backgroundColor:colors.surfaceRaised,borderWidth:1,borderColor:colors.line},copy:{flex:1,minWidth:0},
  date:{color:colors.brand,fontSize:8,fontWeight:'900',textTransform:'uppercase'},title:{marginTop:2,color:colors.ink,fontSize:12,fontWeight:'900',textTransform:'uppercase'},meta:{marginTop:3,color:colors.muted,fontSize:8.5,fontWeight:'700'},
})
