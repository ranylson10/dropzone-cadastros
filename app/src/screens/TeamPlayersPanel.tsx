...
const styles=StyleSheet.create({
  wrap:{gap:spacing.md},
  card:{padding:10,gap:8,backgroundColor:colors.surface,borderWidth:1,borderColor:colors.line,borderRadius:10},
  eyebrow:{color:colors.brand,fontSize:8,fontWeight:'900',letterSpacing:1.3},
  title:{color:colors.ink,fontSize:13,fontWeight:'900',textTransform:'uppercase'},
  ...
  primary:{minHeight:42,borderRadius:8,flexDirection:'row',alignItems:'center',justifyContent:'center',gap:7,backgroundColor:colors.brand},
  ...
  playerRow:{minHeight:50,flexDirection:'row',alignItems:'center',gap:9,paddingVertical:8,borderTopWidth:1,borderTopColor:colors.line},
  inviteRow:{minHeight:52,flexDirection:'row',alignItems:'center',gap:7,paddingVertical:8,borderTopWidth:1,borderTopColor:colors.line},
