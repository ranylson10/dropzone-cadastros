...
const styles=StyleSheet.create({root:{marginHorizontal:spacing.md,gap:8},loading:{minHeight:64,alignItems:'center',justifyContent:'center'},message:{padding:10,color:'#166534',backgroundColor:'#effaf3',fontWeight:'800'},error:{color:'#9a3412',backgroundColor:'#fff7ed'},title:{marginTop:8,color:colors.ink,fontSize:10,fontWeight:'900',letterSpacing:1},chips:{flexDirection:'row',flexWrap:'wrap',gap:5},chip:{paddingHorizontal:9,paddingVertical:8,backgroundColor:'#eee9e1'},chipActive:{backgroundColor:colors.brandDark},chipText:{color:colors.ink,fontSize:8,fontWeight:'900',textTransform:'uppercase'},chipTextActive:{color:colors.surface},nav:{flexDirection:'row',gap:1,backgroundColor:colors.line},navItem:{flex:1,minHeight:36,borderRadius:7,alignItems:'center',justifyContent:'center',backgroundColor:colors.surface},navActive:{backgroundColor:colors.brandDark},navText:{color:colors.muted,fontSize:8,fontWeight:'900',textTransform:'uppercase'},navTextActive:{color:colors.surface},toolbar:{flexDirection:'row',alignItems:'center',gap:5,padding:8,backgroundColor:colors.surface,borderWidth:1,borderColor:colors.line,borderRadius:9},meta:{color:colors.muted,fontSize:8,fontWeight:'700'},secondary:{paddingHorizontal:9,minHeight:34,alignItems:'center',justifyContent:'center',backgroundColor:'#eee9e1'},secondaryText:{color:colors.ink,fontSize:7,fontWeight:'900',textTransform:'uppercase'},primarySmall:{paddingHorizontal:9,minHeight:34,alignItems:'center',justifyContent:'center',backgroundColor:colors.brand},primary:{minHeight:40,borderRadius:8,flexDirection:'row',gap:6,alignItems:'center',justifyContent:'center',backgroundColor:colors.brand},primaryText:{color:colors.surface,fontSize:8,fontWeight:'900',textTransform:'uppercase'},list:{gap:6},card:{gap:7,padding:9,backgroundColor:colors.surface,borderWidth:1,borderColor:colors.line,borderRadius:9},teamHead:{flexDirection:'row',alignItems:'center',gap:6},copy:{flex:1},rowTitle:{color:colors.ink,fontSize:10,fontWeight:'900',textTransform:'uppercase'},columns:{flexDirection:'row',gap:5},label:{marginBottom:4,color:colors.ink,fontSize:7,fontWeight:'900',textTransform:'uppercase'},input:{minHeight:38,paddingHorizontal:8,borderRadius:7,color:colors.ink,backgroundColor:'#f2eee7',borderWidth:1,borderColor:colors.line,fontWeight:'800'},danger:{paddingHorizontal:8,paddingVertical:7,backgroundColor:'#fff1f1'},dangerText:{color:'#b42318',fontSize:7,fontWeight:'900',textTransform:'uppercase'},playerTitle:{marginTop:3,color:colors.ink,fontSize:8,fontWeight:'900'},player:{gap:4,paddingTop:6,borderTopWidth:1,borderTopColor:colors.line},playerName:{color:colors.ink,fontSize:8,fontWeight:'900'},playerFields:{flexDirection:'row',gap:4},mini:{flex:1},miniLabel:{color:colors.muted,fontSize:6,fontWeight:'900'},miniInput:{minHeight:34,paddingHorizontal:6,borderRadius:6,color:colors.ink,backgroundColor:'#f2eee7',fontSize:9,fontWeight:'800'},rank:{minHeight:48,flexDirection:'row',alignItems:'center',gap:8,padding:8,backgroundColor:colors.surface,borderWidth:1,borderColor:colors.line},place:{width:30,color:colors.brand,fontSize:18,fontWeight:'900'},points:{color:colors.ink,fontSize:17,fontWeight:'900',textAlign:'right'},pointsLabel:{color:colors.muted,fontSize:6,fontWeight:'900',textAlign:'right'},empty:{padding:16,color:colors.muted,textAlign:'center',backgroundColor:colors.surface},note:{padding:10,color:colors.muted,fontSize:8,lineHeight:12,backgroundColor:'#eee9e1'}})
