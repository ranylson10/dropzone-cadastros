...
const styles=StyleSheet.create({section:{marginHorizontal:spacing.md,gap:9},title:{marginTop:8,color:colors.ink,fontSize:10,fontWeight:'900',letterSpacing:1},label:{marginBottom:5,color:colors.ink,fontSize:8,fontWeight:'900',textTransform:'uppercase'},input:{minHeight:40,paddingHorizontal:9,borderRadius:7,color:colors.ink,backgroundColor:colors.surfaceRaised,borderWidth:1,borderColor:colors.line,fontWeight:'700'},columns:{flexDirection:'row',gap:6},fieldBox:{flex:1},options:{flexDirection:'row',flexWrap:'wrap',gap:5},option:{paddingHorizontal:9,paddingVertical:8,backgroundColor:colors.surfaceRaised,borderRadius:6},optionActive:{backgroundColor:colors.brand},optionText:{color:colors.ink,fontSize:8,fontWeight:'900',textTransform:'uppercase'},optionTextActive:{color:colors.onBrand},toggle:{minHeight:42,borderRadius:8,flexDirection:'row',alignItems:'center',justifyContent:'space-between',paddingHorizontal:11,backgroundColor:colors.surface,borderWidth:1,borderColor:colors.line},toggleText:{flex:1,color:colors.ink,fontSize:9,fontWeight:'800'},primary:{minHeight:42,borderRadius:8,alignItems:'center',justifyContent:'center',backgroundColor:colors.brand},primaryText:{color:colors.onBrand,fontWeight:'900'},disabled:{opacity:.55},loading:{minHeight:64,alignItems:'center',justifyContent:'center'},error:{padding:9,color:colors.danger,backgroundColor:'rgba(224, 122, 122, .12)',fontSize:9,fontWeight:'800'},success:{padding:9,color:colors.success,backgroundColor:'rgba(101, 185, 130, .12)',fontSize:9,fontWeight:'800'}})
