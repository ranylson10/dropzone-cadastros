...
export function TokenActionScreen(props: {
  ...
  return (
    <ScrollView style={styles.page} contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
      ...
      {detailedAction&&!done?<View style={styles.form}>
        ...
        {resolvedResult.kind==='player_registration'?<>
          ...
          <View style={styles.choices}>
            {['rush','support','granadeiro','sniper','flex'].map(value=><Choice key={value} label={value} active={role===value} onPress={()=>setRole(value)}/>)}
          </View>
        </>:null}
      </View>:null}
