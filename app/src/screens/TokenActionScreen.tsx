...
const styles = StyleSheet.create({
  ...
  center:{flex:1,alignItems:'center',justifyContent:'center',gap:8,backgroundColor:colors.background,padding:20},
  emptyTitle:{color:colors.ink,fontSize:14,fontWeight:'900'},
  hero:{backgroundColor:colors.brandDark,paddingHorizontal:14,paddingVertical:12,borderBottomWidth:2,borderBottomColor:colors.brand},
  back:{width:34,height:34,borderRadius:8,alignItems:'center',justifyContent:'center',backgroundColor:'rgba(255,255,255,.06)',marginBottom:10},
  heroIcon:{width:44,height:44,borderRadius:10,alignItems:'center',justifyContent:'center',backgroundColor:colors.brand,marginBottom:8},
  kicker:{color:'#a8b0bb',fontSize:7,fontWeight:'900',letterSpacing:1.4},
  title:{color:'#fff',fontSize:20,lineHeight:22,fontWeight:'900',textTransform:'uppercase',marginTop:3},
  description:{color:'#c2c8d0',fontSize:10,lineHeight:14,marginTop:5},
  tokenCard:{margin:12,marginBottom:7,padding:11,backgroundColor:'#fff',borderWidth:1,borderColor:'#d7d0c5',borderRadius:10},
  label:{color:colors.brand,fontSize:7,fontWeight:'900',letterSpacing:1.1},
  token:{color:colors.ink,fontSize:15,fontWeight:'900',letterSpacing:1.1,marginTop:3},
  steps:{marginHorizontal:12,marginBottom:8,padding:10,gap:6,backgroundColor:'#fff',borderWidth:1,borderColor:'#d7d0c5',borderRadius:10},step:{flexDirection:'row',alignItems:'center',gap:7},stepText:{color:colors.muted,fontSize:8,fontWeight:'800'},stepTextOk:{color:'#166534'},profileGate:{marginHorizontal:12,marginBottom:8,padding:10,gap:6,backgroundColor:'#fff7ed',borderRadius:9,borderLeftWidth:3,borderLeftColor:colors.brand},profileGateTitle:{color:colors.ink,fontSize:9.5,fontWeight:'900',textTransform:'uppercase'},gateButton:{marginHorizontal:12,marginBottom:8,minHeight:42,flexDirection:'row',alignItems:'center',justifyContent:'center',gap:7,borderRadius:8,backgroundColor:colors.brandDark},gateButtonText:{color:'#fff',fontSize:9,fontWeight:'900',textTransform:'uppercase'},
  infoCard:{marginHorizontal:12,marginBottom:8,padding:10,gap:8,borderRadius:9,backgroundColor:'#e9e3d9'},
  infoRow:{flexDirection:'row',alignItems:'center',gap:8},infoText:{flex:1,color:'#555b64',fontSize:9,lineHeight:13,fontWeight:'700'},
  form:{marginHorizontal:12,marginBottom:8,padding:10,gap:6,backgroundColor:'#fff',borderWidth:1,borderColor:'#d7d0c5',borderRadius:10},
  formTitle:{marginTop:2,color:colors.ink,fontSize:7.5,fontWeight:'900',letterSpacing:.9},
  choices:{flexDirection:'row',flexWrap:'wrap',gap:5},choice:{maxWidth:'100%',paddingHorizontal:8,paddingVertical:7,borderRadius:7,backgroundColor:'#eee9e1'},
  ...
  input:{minHeight:40,paddingHorizontal:9,color:colors.ink,backgroundColor:'#f2eee7',borderWidth:1,borderColor:colors.line,borderRadius:7,fontSize:9.5,fontWeight:'800'},
  hint:{color:colors.muted,fontSize:7.5,lineHeight:11,fontWeight:'700'},inlineLoading:{minHeight:26,flexDirection:'row',alignItems:'center',gap:6},
  result:{marginHorizontal:12,marginBottom:8,padding:9,flexDirection:'row',alignItems:'center',gap:7,borderRadius:8,backgroundColor:'#fff7ed'},
  resultOk:{backgroundColor:'#effaf3'},resultText:{flex:1,color:'#9a3412',fontSize:8.5,lineHeight:12,fontWeight:'800'},resultTextOk:{color:'#166534'},
  primaryButton:{marginHorizontal:12,minHeight:46,paddingHorizontal:13,flexDirection:'row',alignItems:'center',justifyContent:'space-between',borderRadius:8,backgroundColor:colors.brand},
  disabled:{opacity:.55},primaryText:{color:'#fff',fontSize:10,fontWeight:'900',textTransform:'uppercase'},
  secondaryButton:{marginHorizontal:12,marginTop:7,minHeight:42,alignItems:'center',justifyContent:'center',borderRadius:8,borderWidth:1,borderColor:'#cbc4ba',backgroundColor:'#fff'},
  secondaryText:{color:colors.ink,fontSize:9,fontWeight:'900',textTransform:'uppercase'},
})
