...
const styles=StyleSheet.create({root:{marginHorizontal:spacing.md,gap:8},loading:{minHeight:64,alignItems:'center',justifyContent:'center'},message:{padding:10,color:'#166534',backgroundColor:'#effaf3',fontWeight:'800'},error:{color:'#9a3412',backgroundColor:'#fff7ed'},statusCard:{flexDirection:'row',alignItems:'center',gap:8,padding:10,backgroundColor:colors.surface,borderWidth:1,borderColor:colors.line,borderRadius:10},eyebrow:{color:colors.brand,fontSize:7,fontWeight:'900',letterSpacing:1},statusTitle:{color:colors.ink,fontSize:15,fontWeight:'900'},title:{marginTop:8,color:colors.ink,fontSize:10,fontWeight:'900',letterSpacing:1},meta:{color:colors.muted,fontSize:8,fontWeight:'700'},list:{gap:6},rank:{minHeight:46,flexDirection:'row',alignItems:'center',gap:8,padding:8,backgroundColor:colors.surface,borderWidth:1,borderColor:colors.line,borderRadius:8},place:{width:30,color:colors.brand,fontSize:18,fontWeight:'900'},rowTitle:{color:colors.ink,fontSize:9,fontWeight:'900',textTransform:'uppercase'},points:{color:colors.ink,fontSize:11,fontWeight:'900'},chips:{flexDirection:'row',flexWrap:'wrap',gap:5},chip:{paddingHorizontal:9,paddingVertical:8,backgroundColor:'#eee9e1'},chipActive:{backgroundColor:colors.brandDark},chipText:{color:colors.ink,fontSize:8,fontWeight:'900',textTransform:'uppercase'},chipTextActive:{color:colors.surface},form:{gap:7,padding:9,backgroundColor:colors.surface,borderWidth:1,borderColor:colors.line,borderRadius:9},label:{marginBottom:4,color:colors.ink,fontSize:7,fontWeight:'900',textTransform:'uppercase'},input:{minHeight:38,paddingHorizontal:8,color:colors.ink,backgroundColor:'#f2eee7',borderWidth:1,borderColor:colors.line,fontWeight:'800'},primary:{minHeight:40,borderRadius:8,flexDirection:'row',gap:6,alignItems:'center',justifyContent:'center',backgroundColor:colors.brand},primaryText:{color:colors.surface,fontSize:8,fontWeight:'900',textTransform:'uppercase'},secondary:{minHeight:40,borderRadius:8,alignItems:'center',justifyContent:'center',backgroundColor:'#eee9e1'},secondaryText:{color:colors.ink,fontSize:8,fontWeight:'900',textTransform:'uppercase'},prize:{flexDirection:'row',alignItems:'center',gap:8,padding:9,backgroundColor:colors.surface,borderWidth:1,borderColor:colors.line},danger:{width:34,height:34,alignItems:'center',justifyContent:'center',backgroundColor:'#fff1f1'},empty:{padding:12,color:colors.muted,fontSize:8,textAlign:'center',backgroundColor:colors.surface},finalBox:{gap:7,padding:10,backgroundColor:colors.brandDark,borderRadius:10},finalTitle:{color:colors.surface,fontSize:11,fontWeight:'900'},note:{color:'#d7d4cf',fontSize:8,lineHeight:12}})
