...
const styles = StyleSheet.create({
  ...
  loading: { minHeight: 70, borderRadius: 10, alignItems: 'center', justifyContent: 'center', gap: spacing.sm, backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.line },
  ...
  teamCard: { minHeight: 78, flexDirection: 'row', alignItems: 'center', gap: spacing.sm, padding: 10, backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.line, borderTopWidth: 2, borderTopColor: colors.brand, borderRadius: 10 },
  ...
  teamName: { color: colors.ink, fontSize: 14, fontWeight: '900', textTransform: 'uppercase' },
  ...
  emptyCard: { alignItems: 'center', gap: spacing.sm, padding: spacing.lg, borderRadius: 10, backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.line },
  emptyIcon: { width: 48, height: 48, alignItems: 'center', justifyContent: 'center', backgroundColor: '#fff0f2', borderRadius: 24 },
  emptyTitle: { color: colors.ink, fontSize: 14, fontWeight: '900', textAlign: 'center' },
  emptyText: { color: colors.muted, lineHeight: 20, textAlign: 'center' },
  primaryButton: { minHeight: 42, borderRadius: 8, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, paddingHorizontal: spacing.lg, backgroundColor: colors.brandDark },
  primaryButtonText: { color: colors.surface, fontWeight: '900', textTransform: 'uppercase' },
  teamHeader: { minHeight: 70, flexDirection: 'row', alignItems: 'center', gap: spacing.sm, paddingHorizontal: spacing.md, paddingVertical: 8, backgroundColor: colors.brandDark, borderBottomWidth: 3, borderBottomColor: colors.brand },
  backButton: { width: 36, height: 36, borderRadius: 8, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: 'rgba(255,255,255,.18)' },
  teamHeaderCopy: { flex: 1, minWidth: 0 },
  teamHeaderName: { color: colors.surface, fontSize: 15, fontWeight: '900', textTransform: 'uppercase' },
  teamHeaderMeta: { marginTop: 4, color: '#b6bfca', fontSize: typography.caption, fontWeight: '700' },
  sections: { gap: 7 },
  sectionButton: { minWidth: 82, minHeight: 46, borderRadius: 8, alignItems: 'center', justifyContent: 'center', gap: 4, paddingHorizontal: 10, backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.line },
  sectionButtonActive: { backgroundColor: colors.brandDark, borderColor: colors.brandDark },
  sectionLabel: { color: colors.muted, fontSize: 8.5, fontWeight: '900', textTransform: 'uppercase' },
  sectionLabelActive: { color: colors.surface },
  metrics: { flexDirection: 'row', flexWrap: 'wrap', gap: 1, backgroundColor: colors.line, borderRadius: 10, overflow: 'hidden' },
  metric: { width: '49%', flexGrow: 1, padding: 10, backgroundColor: colors.surface },
  ...
  issueCard: { flexDirection: 'row', gap: spacing.sm, padding: 10, borderRadius: 8, backgroundColor: '#eff6ff', borderLeftWidth: 3, borderLeftColor: colors.brand },
  ...
  quickAction: { flex: 1, minHeight: 54, borderRadius: 8, alignItems: 'center', justifyContent: 'center', gap: 5, backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.line },
  quickActionText: { color: colors.ink, fontSize: 8.5, fontWeight: '900', textTransform: 'uppercase' },
  sectionContent: { gap: spacing.sm },
  sectionTitleRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  blockTitle: { color: colors.ink, fontSize: 16, fontWeight: '900', textTransform: 'uppercase' },
  blockSubtitle: { color: colors.muted, fontSize: typography.caption },
  smallAction: { minHeight: 38, borderRadius: 7, flexDirection: 'row', alignItems: 'center', gap: 4, paddingHorizontal: 12, backgroundColor: colors.brandDark },
  smallActionText: { color: colors.surface, fontWeight: '900', textTransform: 'uppercase' },
  inlineForm: { flexDirection: 'row', gap: spacing.sm },
  input: { flex: 1, minHeight: 42, borderRadius: 7, paddingHorizontal: spacing.md, color: colors.ink, backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.line },
  saveButton: { minWidth: 74, borderRadius: 7, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.brand },
  saveButtonText: { color: colors.surface, fontWeight: '900', textTransform: 'uppercase' },
  buttonDisabled: { opacity: 0.5 },
  entityList: { gap: 6 },
  entityRow: { minHeight: 58, flexDirection: 'row', alignItems: 'center', gap: spacing.sm, padding: 7, borderRadius: 8, backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.line },
  entityImage: { width: 44, height: 44, borderRadius: 8, backgroundColor: colors.brandDark },
  ...
  emptyCompact: { minHeight: 96, borderRadius: 10, alignItems: 'center', justifyContent: 'center', gap: spacing.sm, padding: spacing.lg, backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.line },
