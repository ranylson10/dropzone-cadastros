...
const styles=StyleSheet.create({page:{flex:1,backgroundColor:colors.background},content:{paddingBottom:spacing.xxl},hero:{padding:14,backgroundColor:colors.brandDark,borderBottomWidth:2,borderBottomColor:colors.brand},identity:{flexDirection:'row',alignItems:'center',gap:10},avatar:{width:54,height:54,borderRadius:10,backgroundColor:'#202938'},fallback:{alignItems:'center',justifyContent:'center'},initial:{color:colors.surface,fontSize:16,fontWeight:'900'},heroCopy:{flex:1},eyebrow:{color:colors.brand,fontSize:7.5,fontWeight:'900',letterSpacing:1.2},name:{marginTop:2,color:colors.surface,fontSize:17,fontWeight:'900',textTransform:'uppercase'},handle:{marginTop:2,color:'#aeb8c5',fontSize:9.5,fontWeight:'700'},intro:{marginTop:9,color:'#c5ccd5',fontSize:10,lineHeight:14},editProfile:{alignSelf:'flex-start',marginTop:9,minHeight:32,flexDirection:'row',alignItems:'center',gap:5,paddingHorizontal:10,borderRadius:7,backgroundColor:'rgba(255,255,255,.07)'},editProfileText:{color:colors.surface,fontSize:8,fontWeight:'900',textTransform:'uppercase'},statusRow:{margin:12,marginBottom:0,flexDirection:'row',gap:6},status:{flex:1,padding:8,borderRadius:8,backgroundColor:colors.surface,borderWidth:1,borderColor:colors.line},statusLabel:{marginTop:4,color:colors.muted,fontSize:7,fontWeight:'900',textTransform:'uppercase'},statusValue:{marginTop:2,color:colors.ink,fontSize:9,fontWeight:'900'},heading:{margin:12,marginBottom:7},kicker:{color:colors.brand,fontSize:7.5,fontWeight:'900',letterSpacing:1.2},title:{marginTop:2,color:colors.ink,fontSize:16,fontWeight:'900',textTransform:'uppercase'},grid:{paddingHorizontal:12,flexDirection:'row',flexWrap:'wrap',gap:7},card:{width:'48.8%',minHeight:132,padding:10,borderRadius:10,backgroundColor:colors.surface,borderWidth:1,borderColor:colors.line},primary:{backgroundColor:colors.brandDark,borderColor:colors.brandDark},iconBox:{width:36,height:36,borderRadius:9,alignItems:'center',justifyContent:'center',backgroundColor:'#fff0f2'},primaryIcon:{backgroundColor:colors.brand},cardTitle:{marginTop:8,color:colors.ink,fontSize:10,fontWeight:'900',textTransform:'uppercase'},light:{color:colors.surface},description:{flex:1,marginTop:4,color:colors.muted,fontSize:8.5,lineHeight:12,fontWeight:'600'},lightMuted:{color:'#bac3ce'},help:{margin:12,marginTop:13,minHeight:58,flexDirection:'row',alignItems:'center',gap:8,padding:10,borderRadius:10,backgroundColor:'#e8e2d8'},helpCopy:{flex:1},helpTitle:{color:colors.ink,fontSize:9.5,fontWeight:'900'},helpText:{marginTop:2,color:colors.muted,fontSize:8.5,lineHeight:12,fontWeight:'700'}})
