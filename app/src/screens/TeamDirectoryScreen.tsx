...
const styles = StyleSheet.create({
  ...
  searchBox: { margin: spacing.md, marginBottom: 9, height: 44, flexDirection: 'row', alignItems: 'center', gap: 9, paddingHorizontal: 12, backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.line, borderRadius: 10 },
  ...
  error: { marginHorizontal: spacing.md, marginBottom: 8, padding: 10, color: colors.danger, backgroundColor: 'rgba(224, 122, 122, .12)', fontSize: 11, fontWeight: '800' },
  emptyRow: { marginHorizontal: spacing.md, minHeight: 76, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.line, borderRadius: 10 },
  emptyText: { color: colors.muted, fontSize: 12, fontWeight: '800' },
  teamList: { marginHorizontal: spacing.md, gap: 8 },
  teamRow: { minHeight: 62, flexDirection: 'row', alignItems: 'center', gap: 10, paddingHorizontal: 10, paddingVertical: 7, backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.line, borderRadius: 10 },
  teamLogo: { width: 46, height: 46, backgroundColor: colors.surfaceRaised, borderWidth: 1, borderColor: colors.line, borderRadius: 8 },
  teamLogoFallback: { alignItems: 'center', justifyContent: 'center', backgroundColor: colors.brandDark },
  teamInitial: { color: colors.ink, fontSize: 12, fontWeight: '900' },
  ...
  teamMeta: { marginTop: 3, color: colors.muted, fontSize: 9, fontWeight: '700' },
})
