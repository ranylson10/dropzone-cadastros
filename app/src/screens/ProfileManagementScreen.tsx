...
export function ProfileManagementScreen({onNavigate,onSelectPlayer,onSelectTeam}:ScreenProps){
  ...
  async function chooseImage(){
    ...
    if(!permission.granted){setError('Permita o acesso à galeria para escolher uma imagem.');return}
    ...
    try{
      const converted=await ImageManipulator.manipulateAsync(result.assets[0].uri,[{resize:{width:800}}],{compress:.86,format:ImageManipulator.SaveFormat.PNG,base64:true})
