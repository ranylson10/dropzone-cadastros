...
const styles = StyleSheet.create({
  page:{flex:1,backgroundColor:colors.background},content:{paddingBottom:spacing.lg},search:{margin:spacing.md,height:44,flexDirection:'row',alignItems:'center',gap:8,paddingHorizontal:11,backgroundColor:'#ebe6dd',borderWidth:1,borderColor:'#d2cbc1'},input:{flex:1,color:colors.ink,fontSize:12,fontWeight:'700'},loading:{minHeight:52,flexDirection:'row',alignItems:'center',justifyContent:'center',gap:8},error:{marginHorizontal:spacing.md,marginBottom:8,padding:10,backgroundColor:'#fff7ed',color:'#9a3412',fontWeight:'800'},list:{marginHorizontal:spacing.md,gap:1,backgroundColor:'#cfc8be'},row:{minHeight:64,flexDirection:'row',alignItems:'center',gap:10,padding:8,backgroundColor:'#e8e2d8'},avatar:{width:46,height:46,backgroundColor:'#f7f3ec'},fallback:{alignItems:'center',justifyContent:'center'},copy:{flex:1},name:{color:colors.ink,fontSize:12.5,fontWeight:'900',textTransform:'uppercase'},meta:{marginTop:3,color:'#706b64',fontSize:9,fontWeight:'700'},empty:{margin:spacing.md,padding:15,textAlign:'center',color:colors.muted,backgroundColor:'#e7e1d8',fontWeight:'800'}
})
