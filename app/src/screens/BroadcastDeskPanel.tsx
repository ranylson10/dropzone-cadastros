...
const styles=StyleSheet.create({
  ...
  card:{gap:7,padding:9,backgroundColor:colors.surface,borderWidth:1,borderColor:colors.line,borderRadius:10},
  ...
  input:{minHeight:40,paddingHorizontal:9,borderRadius:7,color:colors.ink,backgroundColor:'#f2eee7',borderWidth:1,borderColor:colors.line,fontWeight:'800'},
  primary:{minHeight:42,borderRadius:8,flexDirection:'row',alignItems:'center',justifyContent:'center',gap:6,backgroundColor:colors.brand},
