...
const styles = StyleSheet.create({
  root:{marginHorizontal:spacing.md,gap:8},queueHeader:{flexDirection:'row',alignItems:'center',justifyContent:'space-between'},queueCount:{minWidth:26,height:22,paddingHorizontal:7,alignItems:'center',justifyContent:'center',backgroundColor:colors.brand},queueCountText:{color:colors.surface,fontSize:9,fontWeight:'900'},queue:{gap:6},requestCard:{flexDirection:'row',alignItems:'center',gap:6,padding:8,backgroundColor:colors.surface,borderWidth:1,borderColor:colors.line,borderRadius:8},requestCardActive:{borderColor:colors.brand,borderWidth:2},reviewButton:{paddingHorizontal:9,paddingVertical:7,backgroundColor:colors.brandDark,borderRadius:7},reviewButtonText:{color:colors.surface,fontSize:7,fontWeight:'900',textTransform:'uppercase'},rejectButton:{paddingHorizontal:9,paddingVertical:7,backgroundColor:'#fff1f1',borderRadius:7},rejectButtonText:{color:'#b42318',fontSize:7,fontWeight:'900',textTransform:'uppercase'},loading:{minHeight:72,alignItems:'center',justifyContent:'center'},metrics:{flexDirection:'row',gap:1,backgroundColor:colors.line,borderRadius:9,overflow:'hidden'},metric:{flex:1,padding:9,backgroundColor:colors.surface},metricValue:{color:colors.ink,fontSize:18,fontWeight:'900'},metricLabel:{color:colors.muted,fontSize:7,fontWeight:'900',textTransform:'uppercase'},message:{padding:9,color:'#166534',backgroundColor:'#effaf3',borderRadius:8,fontWeight:'800'},error:{color:'#9a3412',backgroundColor:'#fff7ed'},title:{marginTop:8,color:colors.ink,fontSize:10,fontWeight:'900',letterSpacing:1},chips:{flexDirection:'row',flexWrap:'wrap',gap:5},chip:{paddingHorizontal:9,paddingVertical:7,backgroundColor:'#eee9e1',borderRadius:6},chipActive:{backgroundColor:colors.brandDark},chipText:{color:colors.ink,fontSize:8,fontWeight:'900',textTransform:'uppercase'},chipTextActive:{color:colors.surface},selection:{flexDirection:'row',alignItems:'center',gap:8,padding:9,backgroundColor:'#fff7ed',borderWidth:1,borderColor:'#fed7aa',borderRadius:8},selectionLabel:{color:'#9a3412',fontSize:7,fontWeight:'900'},selectionName:{marginTop:2,color:colors.ink,fontSize:11,fontWeight:'900',textTransform:'uppercase'},selectionMeta:{marginTop:2,color:colors.muted,fontSize:8},iconButton:{width:34,height:34,borderRadius:7,alignItems:'center',justifyContent:'center',backgroundColor:'#eee9e1'},list:{gap:5},slotRow:{minHeight:54,borderRadius:8,flexDirection:'row',alignItems:'center',gap:8,padding:7,backgroundColor:colors.surface,borderWidth:1,borderColor:colors.line},slotRowSelected:{borderColor:colors.brand,borderWidth:2},slotBadge:{width:36,height:36,borderRadius:7,alignItems:'center',justifyContent:'center'},slotOccupied:{backgroundColor:colors.brandDark},slotFree:{backgroundColor:'#e7efe8'},slotBadgeText:{color:colors.ink,fontWeight:'900'},copy:{flex:1},rowTitle:{color:colors.ink,fontSize:10,fontWeight:'900',textTransform:'uppercase'},meta:{marginTop:2,color:colors.muted,fontSize:8,fontWeight:'700'},smallAction:{width:32,height:32,borderRadius:7,alignItems:'center',justifyContent:'center',backgroundColor:'#f2eee7'},addAction:{minHeight:34,borderRadius:7,flexDirection:'row',alignItems:'center',gap:3,paddingHorizontal:8,backgroundColor:colors.brand},addActionText:{color:colors.surface,fontSize:7,fontWeight:'900',textTransform:'uppercase'},searchBox:{gap:7,padding:9,backgroundColor:colors.surface,borderWidth:1,borderColor:colors.line,borderRadius:10},searchHeader:{flexDirection:'row',alignItems:'center'},searchLine:{flexDirection:'row'},input:{flex:1,minHeight:40,paddingHorizontal:10,color:colors.ink,backgroundColor:'#f2eee7',borderWidth:1,borderColor:colors.line,borderRadius:7,fontWeight:'700'},searchButton:{width:42,borderRadius:7,alignItems:'center',justifyContent:'center',backgroundColor:colors.brand},teamCard:{gap:6,padding:8,backgroundColor:'#f8f5ef',borderWidth:1,borderColor:colors.line,borderRadius:8},teamHead:{flexDirection:'row',alignItems:'center',gap:8},logo:{width:38,height:38,borderRadius:8,backgroundColor:'#eee9e1'},logoFallback:{alignItems:'center',justifyContent:'center'},lineRow:{minHeight:42,flexDirection:'row',alignItems:'center',gap:8,paddingLeft:6,borderTopWidth:1,borderTopColor:colors.line},lineName:{color:colors.ink,fontSize:9,fontWeight:'900',textTransform:'uppercase'},useButton:{paddingHorizontal:10,paddingVertical:7,backgroundColor:colors.brandDark,borderRadius:7},useButtonText:{color:colors.surface,fontSize:7,fontWeight:'900',textTransform:'uppercase'},disabled:{opacity:.35},emptySmall:{paddingVertical:8,color:colors.muted,fontSize:8,textAlign:'center'},note:{marginTop:4,padding:9,color:colors.muted,fontSize:8,lineHeight:12,backgroundColor:'#eee9e1',borderRadius:8},
})
