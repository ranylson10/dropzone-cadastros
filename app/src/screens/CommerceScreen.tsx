...
const styles=StyleSheet.create({
  summary:{backgroundColor:'#0b1320',padding:12,borderBottomLeftRadius:10,borderBottomRightRadius:10,gap:spacing.md,borderBottomWidth:3,borderBottomColor:colors.brand},
  summaryTop:{flexDirection:'row',alignItems:'center',justifyContent:'space-between'},
  summaryKicker:{color:colors.gold,fontSize:8,fontWeight:'900',letterSpacing:1.2},
  summaryValue:{marginTop:4,color:colors.surface,fontSize:24,fontWeight:'900'},
  bag:{width:38,height:38,borderRadius:9,alignItems:'center',justifyContent:'center',backgroundColor:colors.brand},
  ...
  walletStrip:{flexDirection:'row',alignItems:'center',gap:8,padding:9,backgroundColor:'#eee9e1',borderWidth:1,borderColor:colors.line,borderRadius:9},
  ...
  sectionTitle:{marginTop:2,color:colors.ink,fontSize:15,fontWeight:'900'},
  ...
  card:{gap:8,padding:10,backgroundColor:colors.surface,borderWidth:1,borderColor:colors.line,borderRadius:10},
  cardHead:{flexDirection:'row',alignItems:'center',gap:9},
  logo:{width:40,height:40,borderRadius:8,backgroundColor:'#f3efe8'},
  ...
  quantityBar:{minHeight:42,borderRadius:8,flexDirection:'row',alignItems:'center',gap:8,paddingHorizontal:9,backgroundColor:'#eee9e1'},
  ...
  nativeButton:{minHeight:40,borderRadius:8,flexDirection:'row',alignItems:'center',justifyContent:'center',gap:7,backgroundColor:'#eee9e1',borderWidth:1,borderColor:colors.line},
  nativeButtonText:{color:colors.ink,fontSize:8,fontWeight:'900',textTransform:'uppercase'},
  favorite:{minHeight:48,borderRadius:9,flexDirection:'row',alignItems:'center',justifyContent:'space-between',gap:8,padding:10,backgroundColor:colors.surface,borderWidth:1,borderColor:colors.line},
