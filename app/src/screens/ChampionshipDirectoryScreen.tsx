...
const styles=StyleSheet.create({page:{flex:1,backgroundColor:colors.background},content:{paddingBottom:spacing.xl},searchBox:{margin:spacing.md,marginBottom:8,height:42,flexDirection:'row',alignItems:'center',gap:8,paddingHorizontal:11,backgroundColor:colors.surface,borderWidth:1,borderColor:colors.line,borderRadius:6},searchInput:{flex:1,color:colors.ink,fontSize:12,fontWeight:'700',paddingVertical:0},filterRow:{paddingHorizontal:spacing.md,paddingBottom:10,gap:6},filter:{minHeight:32,paddingHorizontal:13,alignItems:'center',justifyContent:'center',backgroundColor:colors.surface,borderWidth:1,borderColor:colors.line,borderRadius:6},filterActive:{backgroundColor:colors.brand,borderColor:colors.brand},filterText:{color:colors.ink,fontSize:9,fontWeight:'900',textTransform:'uppercase'},filterTextActive:{color:colors.onBrand},loading:{minHeight:52,flexDirection:'row',alignItems:'center',justifyContent:'center',gap:8},loadingText:{color:colors.muted,fontSize:11,fontWeight:'700'},error:{marginHorizontal:spacing.md,marginBottom:8,padding:10,backgroundColor:'rgba(224,122,122,.14)',color:colors.danger,fontSize:11,fontWeight:'800'},list:{marginHorizontal:spacing.md,gap:12},empty:{margin:spacing.md,padding:15,backgroundColor:colors.surface,color:colors.muted,textAlign:'center',fontSize:11,fontWeight:'800'}})
