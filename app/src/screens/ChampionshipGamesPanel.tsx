...
const styles=StyleSheet.create({root:{marginHorizontal:spacing.md,gap:7},loading:{minHeight:72,alignItems:'center',justifyContent:'center'},message:{padding:9,color:'#166534',backgroundColor:'#effaf3',borderRadius:8,fontWeight:'800'},error:{color:'#9a3412',backgroundColor:'#fff7ed'},title:{marginTop:8,color:colors.ink,fontSize:10,fontWeight:'900',letterSpacing:1},chips:{flexDirection:'row',flexWrap:'wrap',gap:5},chip:{paddingHorizontal:9,paddingVertical:7,backgroundColor:'#eee9e1',borderRadius:6},chipActive:{backgroundColor:colors.brandDark},chipText:{color:colors.ink,fontSize:8,fontWeight:'900',textTransform:'uppercase'},chipTextActive:{color:colors.surface},form:{gap:7,padding:9,backgroundColor:colors.surface,borderWidth:1,borderColor:colors.line,borderRadius:10},finalPanel:{gap:7,padding:9,backgroundColor:'#f2eee7',borderLeftWidth:3,borderLeftColor:colors.brand,borderRadius:8},finalPanelTitle:{color:colors.brand,fontSize:9,fontWeight:'900',letterSpacing:1},columns:{flexDirection:'row',gap:6},label:{marginBottom:5,color:colors.ink,fontSize:8,fontWeight:'900',textTransform:'uppercase'},input:{minHeight:40,paddingHorizontal:10,color:colors.ink,backgroundColor:'#f2eee7',borderWidth:1,borderColor:colors.line,borderRadius:7,fontWeight:'700'},actions:{flexDirection:'row',gap:6},primary:{minHeight:40,borderRadius:7,flex:1,alignItems:'center',justifyContent:'center',backgroundColor:colors.brand},primaryText:{color:colors.surface,fontSize:9,fontWeight:'900',textTransform:'uppercase'},secondary:{minHeight:40,borderRadius:7,paddingHorizontal:14,alignItems:'center',justifyContent:'center',backgroundColor:'#eee9e1'},secondaryText:{color:colors.ink,fontSize:8,fontWeight:'900',textTransform:'uppercase'},list:{gap:6},card:{padding:8,backgroundColor:colors.surface,borderWidth:1,borderColor:colors.line,borderRadius:8},cardHead:{minHeight:42,flexDirection:'row',alignItems:'center',gap:6},copy:{flex:1},rowTitle:{color:colors.ink,fontSize:10,fontWeight:'900',textTransform:'uppercase'},meta:{marginTop:2,color:colors.muted,fontSize:8,fontWeight:'700'},icon:{width:34,height:34,borderRadius:7,alignItems:'center',justifyContent:'center',backgroundColor:'#f2eee7'},statuses:{flexDirection:'row',flexWrap:'wrap',gap:4,marginTop:5},statusChip:{paddingHorizontal:7,paddingVertical:6,backgroundColor:'#eee9e1',borderRadius:6},statusChipActive:{backgroundColor:colors.brandDark},statusText:{color:colors.muted,fontSize:7,fontWeight:'900',textTransform:'uppercase'},statusTextActive:{color:colors.surface},mapRow:{flexDirection:'row',alignItems:'flex-start',gap:6},fallBadge:{width:34,height:34,borderRadius:7,alignItems:'center',justifyContent:'center',backgroundColor:colors.brandDark},fallText:{color:colors.surface,fontSize:9,fontWeight:'900'},mapChips:{flex:1,flexDirection:'row',flexWrap:'wrap',gap:4},mapChip:{paddingHorizontal:8,paddingVertical:7,backgroundColor:'#eee9e1',borderRadius:6},mapChipActive:{backgroundColor:colors.brand},mapText:{color:colors.ink,fontSize:7,fontWeight:'900',textTransform:'uppercase'},mapTextActive:{color:colors.surface},actionsSmall:{flexDirection:'row',gap:5,marginTop:4},smallButton:{paddingHorizontal:9,paddingVertical:7,backgroundColor:'#eee9e1',borderRadius:6},smallText:{color:colors.ink,fontSize:7,fontWeight:'900',textTransform:'uppercase'},dangerButton:{backgroundColor:'#fff1f1'},dangerText:{color:'#b42318'},falls:{gap:5,marginTop:8,paddingTop:8,borderTopWidth:1,borderTopColor:colors.line},fallRow:{minHeight:48,flexDirection:'row',alignItems:'center',gap:7},inlineMaps:{maxWidth:'45%',flexDirection:'row',flexWrap:'wrap',justifyContent:'flex-end',gap:3},tinyMap:{paddingHorizontal:5,paddingVertical:5,backgroundColor:'#eee9e1'},tinyMapText:{color:colors.ink,fontSize:6.5,fontWeight:'900'},note:{padding:9,color:colors.muted,fontSize:8,lineHeight:12,backgroundColor:'#eee9e1',borderRadius:8}})
