...
export const mobileApi = {
  ...
  championshipPhaseGameConfig: (id:string, phaseId:string, accessToken?:string|null) => dropzoneFetch<any>(`/api/campeonatos/${encodeURIComponent(id)}/fases/${encodeURIComponent(phaseId)}/configuracao-jogos`, {accessToken,cache:'no-store'}),
  updateChampionshipPhaseGameConfig: (id:string, phaseId:string, body:Record<string,unknown>, accessToken?:string|null) => dropzoneFetch<any>(`/api/campeonatos/${encodeURIComponent(id)}/fases/${encodeURIComponent(phaseId)}/configuracao-jogos`, {method:'PUT',accessToken,body:JSON.stringify(body)}),
  applyChampionshipPointRushBonus: (id:string, phaseId:string, accessToken?:string|null) => dropzoneFetch<any>(`/api/campeonatos/${encodeURIComponent(id)}/fases/${encodeURIComponent(phaseId)}/configuracao-jogos/aplicar-bonus`, {method:'POST',accessToken}),
  championshipChampionSummary: (id:string) => dropzoneFetch<any>(`/api/campeonatos/${encodeURIComponent(id)}/estatisticas/campeao`, {cache:'no-store'}),
